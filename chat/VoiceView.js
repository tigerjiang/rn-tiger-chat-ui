       ...
       return (
         errorText !== '' ? (
           <View style={{ justifyContent: 'center', alignItems: 'center', width: 150, height: 150 }}>
             {errorIcon || <ImageComponent source={require('../source/voiceError.png')} style={{ width: 60, height: 60 }} />}
             <Text style={{ color: '#fff', marginTop: 10, textAlign: 'center' }}>{errorText}</Text>
           </View>
         ) : !voiceStatus ? (
           <View style={{ justifyContent: 'center', alignItems: 'center', width: 150, height: 150 }}>
             {cancelIcon || <ImageComponent source={require('../source/voiceCancel.png')} style={{ width: 60, height: 60 }} />}
